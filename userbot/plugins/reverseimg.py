...
async def okgoogle(img):
    ...
    if message and message.media:
        ...
        await img.edit("`Reply To An Image Or Sticker!`")
        return
    ...
    if photo:
        ...
        if response != 400:
            await img.edit("`Searching For Image!`"
                           "\n`Looking Over The Internet!`")
        else:
            await img.edit("`Can't Search!`")
            return
